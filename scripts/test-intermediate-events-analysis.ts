/**
 * Test script to verify the analysis of intermediate events in sequence flows
 * 
 * This script:
...
const FIXTURES_DIR = resolve(__dirname, '..', 'tests', 'fixtures', 'bpmn', 'analytics');
...
async function main() {
  console.log('=== Test: Intermediate Events Analysis ===\n');
