...
3. När Process Explorer eller lokalgenereringen körs byggs hela grafen först, därefter vandrar vi igenom noderna i samma struktur.
...
- `generateAllFromBpmnWithGraph` använder samma struktur (dock med egna in-memory set för att undvika dubbletter) när vi genererar dokumentation/tester/doR.
