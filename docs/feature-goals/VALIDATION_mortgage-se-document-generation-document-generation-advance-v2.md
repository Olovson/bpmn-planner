# Validering: mortgage-se-document-generation-document-generation-advance-v2.html
...
3. **Acceptanskriterier → Tekniska krav**: 
   ...
   - Tagit bort funktionella krav (sektioner 1, 3)
   - Behållit endast tekniska krav (sektioner 2, 4, 5)
