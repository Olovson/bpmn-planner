# Validering: mortgage-se-disbursement-v2.html
...
- ✅ Organiserade i kategorier (Handläggarperspektiv, Systemperspektiv)
...
3. **Acceptanskriterier → Tekniska krav**: 
   ...
   - Tagit bort funktionella krav (sektioner 1-3, 4, 5, 6)
   - Behållit endast tekniska krav (sektioner 7, 8, 9)
