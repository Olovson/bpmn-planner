...
3. **Acceptanskriterier → Tekniska krav**: 
   ...
   - Tagit bort funktionella krav (sektioner 1-7, 9)
   - Behållit endast tekniska krav (sektioner 8, 10, 11)
