...
### Hög prioritet (5+ problematiska user stories)

1. **mortgage-manual-credit-evaluation-v2.html** (8/9 user stories behöver uppdateras)
   - Många acceptanskriterier börjar med "Efter", "När", "Om" + BPMN-referenser

2. **mortgage-kyc-v2.html** (7/9 user stories behöver uppdateras)
   - Många acceptanskriterier börjar med "Efter" + BPMN-referenser

3. **mortgage-offer-v2.html** (7/8 user stories behöver uppdateras)
   - Många acceptanskriterier börjar med "Om", "När" + BPMN-referenser

4. **mortgage-mortgage-commitment-v2.html** (6/11 user stories behöver uppdateras)
   - Många acceptanskriterier börjar med "När", "Om" + BPMN-referenser

5. **mortgage-se-credit-decision-v2.html** (5/6 user stories behöver uppdateras)
   - Många acceptanskriterier börjar med "När systemet dirigerar..." + BPMN-referenser

6. **mortgage-se-credit-decision-sales-contract-credit-decision-v2.html** (5/6 user stories behöver uppdateras)
   - Många acceptanskriterier börjar med "När systemet dirigerar..." + BPMN-referenser

### Medel prioritet (2-4 problematiska user stories)

7. **mortgage-appeal-v2.html** (3/10 user stories behöver uppdateras)
   - Några acceptanskriterier börjar med "När" + BPMN-referenser

8. **mortgage-se-application-object-v2.html** (3/4 user stories behöver uppdateras)
   - Många acceptanskriterier börjar med "När", "Efter" + BPMN-referenser

9. **mortgage-se-signing-v2.html** (3/13 user stories behöver uppdateras)
   - Några acceptanskriterier börjar med BPMN-referenser

10. **mortgage-application-v2.html** (2/12 user stories behöver uppdateras)
...
11. **mortgage-se-documentation-assessment-v2.html** (2/7 user stories behöver uppdateras)
    - Några acceptanskriterier börjar med "När" + BPMN-referenser

12. **mortgage-se-application-stakeholder-v2.html** (2/4 user stories behöver uppdateras)
    - Några acceptanskriterier börjar med BPMN-referenser

### Låg prioritet (1 problematisk user story)

13. **mortgage-collateral-registration-v2.html** (1/9 user stories behöver uppdateras)
    - En acceptanskriterie börjar med "Om" + BPMN-referens

14. **mortgage-se-disbursement-disbursement-advance-v2.html** (1/4 user stories behöver uppdateras)
    - En acceptanskriterie börjar med BPMN-referens

15. **mortgage-se-disbursement-v2.html** (1/4 user stories behöver uppdateras)
    - En acceptanskriterie börjar med BPMN-referens

16. **mortgage-se-manual-credit-evaluation-object-control-v2.html** (1/14 user stories behöver uppdateras)
