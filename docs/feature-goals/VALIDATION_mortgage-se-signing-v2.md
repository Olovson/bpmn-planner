# Validering: mortgage-se-signing-v2.html
...
- ✅ Organiserade i kategorier (Systemperspektiv, Handläggarperspektiv, Kundperspektiv)
...
3. **Acceptanskriterier → Tekniska krav**: 
   ...
   - Tagit bort funktionella krav (sektioner 1-5)
   - Behållit endast tekniska krav (sektion 6, 7, 8)
