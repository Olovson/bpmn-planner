# Validering: mortgage-offer-v2.html

## Systematisk validering av alla 12 sektioner

### 1. Beskrivning av FGoal ✅
- [x] Tydlig beskrivning av vad feature goalet gör
- [x] Vem som utför aktiviteten (kund, handläggare, system) - JA: "kunden acceptera, avvisa eller begära ändringar"
...
- [x] Testdata-referenser (t.ex. "offer-contract-assessed-happy", "offer-upload-contract")
- [x] Implementation mapping (om relevant)

### 9. Effekt ✅
- [x] Executive Summary (direktörsvänlig, kortfattad, 3-4 kategorier) - REDAN FINNS
- [x] Volym-baserade beräkningar (100 000 ansökningar per år, 50-70% når Offer-stadiet) - REDAN FINNS
- [x] Detaljerade sektioner med tabeller (OBLIGATORISKT):
  - [x] Sektion 1: Förbättrad kundupplevelse och minskad felaktiga acceptanser (med tabell) - REDAN FINNS
  - [x] Sektion 2: Processeffektivitet och automatisering (med tabell) - REDAN FINNS
  - [x] Sektion 3: Kapacitetsökning (med tabell) - LAGTS TILL
- [x] Jämförelse med nuvarande process (tabell) - REDAN FINNS
- [x] Aggregeringsinformation (OBLIGATORISKT - tabell med kolumner: Effekt, Typ, Volym, Aggregeringsbar, Redan inkluderad i parent) - REDAN FINNS
- [x] Alla siffror är konservativa uppskattningar och markeras som sådana - REDAN FINNS
