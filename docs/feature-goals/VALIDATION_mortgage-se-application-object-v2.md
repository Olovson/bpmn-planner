# Validering: mortgage-se-application-object-v2.html

## Systematisk validering av alla 12 sektioner

### 1. Beskrivning av FGoal ✅
- [x] Tydlig beskrivning av vad feature goalet gör
- [x] Vem som utför aktiviteten (kund, handläggare, system) - JA: "primary stakeholder", "handläggare"
...
- [x] Volym-baserade beräkningar (100 000 ansökningar per år, 1-2 objekt per ansökan) - UPPDATERAD
...
- [x] Organiserade i kategorier (Primary stakeholder-perspektiv, Handläggarperspektiv)
