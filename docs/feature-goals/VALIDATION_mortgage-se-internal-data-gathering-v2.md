# Validering: mortgage-se-internal-data-gathering-v2.html
...
3. **Acceptanskriterier → Tekniska krav**: 
   ...
   - Tagit bort funktionella krav (sektioner 1-6)
   - Behållit endast tekniska krav (organiserade i kategorier)
